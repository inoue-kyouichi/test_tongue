 ...
 * @param [in] stress
 */
void ShapeFunction::C2D4_dNdr(DOUBLEARRAY2D &dNdr,const double &g1,const double &g2)
{
 ...
 * @param [in] stress
 */
void ShapeFunction::C2D4_N(DOUBLEARRAY1D &N,const double &g1,const double &g2)
{
 ...
 * @param [in] stress
 */
void ShapeFunction::C2D8_dNdr(DOUBLEARRAY2D &dNdr,const double &g1,const double &g2)
{
...
void ShapeFunction::C2D8_N(DOUBLEARRAY1D &N,const double &g1,const double &g2)
{
...
void ShapeFunction::C2D9_d2Ndr2(DOUBLEARRAY2D &d2Ndr2,const double &g1,const double &g2)
{
...
void ShapeFunction::C2D9_dNdr(DOUBLEARRAY2D &dNdr,const double &g1,const double &g2)
{
...
void ShapeFunction::C2D9_N(DOUBLEARRAY1D &N,const double &g1,const double &g2)
{
 ...
 * @param [in] stress
 */
void ShapeFunction::C3D8_dNdr(DOUBLEARRAY2D &dNdr,const double &g1,const double &g2,const double &g3)
{
 ...
 * @param [in] stress
 */
void ShapeFunction::C3D8_N(DOUBLEARRAY1D &N,const double &g1,const double &g2,const double &g3)
{
 ...
 * @param [in] stress
 */
void ShapeFunction::C3D20_dNdr(DOUBLEARRAY2D &dNdr,const double &g1,const double &g2,const double &g3)
{
...
void ShapeFunction::C3D27_dNdr(DOUBLEARRAY2D &dNdr,const double &g1,const double &g2,const double &g3)
{
 ...
 * @param [in] stress
 */
void ShapeFunction::C3D20_N(DOUBLEARRAY1D &N,const double &g1,const double &g2,const double &g3)
{
 ...
 * @param [in] stress
 */
void ShapeFunction::C3D27_N(DOUBLEARRAY1D &N,const double &g1,const double &g2,const double &g3)
{
 ...
 * @param [in] stress
 */
void ShapeFunction::C3D4_N(DOUBLEARRAY1D &N,const double &L1,const double &L2,const double &L3,const double &L4)
{
  N[0]=L1;
  N[1]=L2;
  N[2]=L3;
 ...
 * @param [in] stress
 */
void ShapeFunction::C3D4_dNdr(DOUBLEARRAY2D &dNdr,const double &L1,const double &L2,const double &L3,const double &L4)
{
 ...
 * @param [in] stress
 */
void ShapeFunction::C3D10_N(DOUBLEARRAY1D &N,const double &L1,const double &L2,const double &L3,const double &L4)
{
  N[0] = L1*(2e0*L1-1e0);
  N[1] = L2*(2e0*L2-1e0);
  N[2] = L3*(2e0*L3-1e0);
 ...
 * @param [in] stress
 */
void ShapeFunction::C3D10_dNdr(DOUBLEARRAY2D &dNdr,const double &L1,const double &L2,const double &L3,const double &L4)
{
  dNdr[0][0] = 4e0*L1-1e0;
  dNdr[0][1] = 0e0;
  dNdr[0][2] = 0e0;
 ...
 * @param [in] stress
 */
void ShapeFunction::C2D6_dNdr(DOUBLEARRAY2D &dNdr,const double &L1,const double &L2,const double &L3)
{
  dNdr[0][0] = -4e0*L1+1e0;
  dNdr[0][1] = -4e0*L1+1e0;
 ...
 * @param [in] stress
 */
void ShapeFunction::C2D6_N(DOUBLEARRAY1D &N,const double &L1,const double &L2,const double &L3)
{
  N[0] = L1 * (2e0*L1-1e0);
  N[1] = L2 * (2e0*L2-1e0);
  N[2] = L3 * (2e0*L3-1e0);
 ...
 * @param [in] stress
 */
void ShapeFunction::C2D3_dNdr(DOUBLEARRAY2D &dNdr,const double &L1,const double &L2,const double &L3)
{
  dNdr[0][0] = -1e0;
  dNdr[0][1] = -1e0;
 ...
 * @param [in] stress
 */
void ShapeFunction::C2D3_N(DOUBLEARRAY1D &N,const double &L1,const double &L2,const double &L3)
{
  N[0] = L1;
  N[1] = L2;
  N[2] = L3;
 ...
 * @param [in] stress
 */
void ShapeFunction::C3D6_N(DOUBLEARRAY1D &N,const double &L1,const double &L2,const double &L3,const double &g1)
{
  N[0] = 5e-1*L1*(1e0-g1);
  N[1] = 5e-1*L2*(1e0-g1);
  N[2] = 5e-1*L3*(1e0-g1);
 ...
 * @param [in] stress
 */
void ShapeFunction::C3D6_dNdr(DOUBLEARRAY2D &dNdr,const double &L1,const double &L2,const double &L3,const double &g1)
{

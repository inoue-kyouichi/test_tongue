...
double Fem::line_search(const double *u)
{
  ...
  DOUBLEARRAY2 U_tmp=Allocation::allocate2dDOUBLE(numOfNode,3);
  DOUBLEARRAY2 innerForce_tmp=Allocation::allocate2dDOUBLE(numOfNode,3);
 ...
 */
double Fem::line_search_innerProduct(const DOUBLEARRAY2 &Q,const double *u)
{
  double s=0e0;
 ...
 */
void Fem::calc_Q(DOUBLEARRAY2 &innerForce_tmp,const DOUBLEARRAY2 &U_tmp)
{

 ...
 */
void SmoothedFEM::SFEM::calcStressTensor_SantVenant_element_spatialForm(const int ic,ARRAY2D<double> &U_tmp,const bool option)
{
 ...
 * @param [in] option           true or faluse: calculate tangential stiffness matrix or not.
 */
double SmoothedFEM::SFEM::SantVenant_inGaussIntegral(ARRAY2D<double> &dNdr,ARRAY2D<double> &x_current,ARRAY2D<double> &x_ref,
